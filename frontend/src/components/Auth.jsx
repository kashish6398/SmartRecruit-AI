  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-container">
        <div className="auth-left" style={{ backgroundImage: `url(${heroBg})` }}>
          ...
          <div className="auth-left-content">
            ...
            <h1>Accelerate Your Hiring Process</h1>
            <p>The smartest AI-powered talent acquisition platform for modern teams. Screen resumes, rank candidates, and hire better, faster.</p>
        ...
        <div className="auth-right">
          <div className="auth-form-wrapper">
            ...
            <div className="auth-header">
              ...
              <p>{isLogin ? 'Glad to see you again! Please sign in.' : 'Start your journey with us today.'}</p>
            </div>
            ...
            <form className="auth-form" onSubmit={handleSubmit}>
              ...
              <div className="form-group slide-up">
                <div className="label-row">
                  ...
                  {isLogin && <button type="button" className="link-btn forgot-password" onClick={() => alert("Keep it simple! Use your previous password.")}>
                    Forgot?
                  </button>}
                </div>
                <div className="input-container">
            ...
            <div className="social-buttons">
                ...
                <button type="button" className="social-btn" onClick={() => alert('LinkedIn login coming soon!')}>
